...
#define TFT_MOSI 47 // In some display driver board, it might be written as "SDA" and so on.
#define TFT_SCLK 21
#define TFT_CS   44  // Chip select control pin
#define TFT_DC   43  // Data Command control pin
